...
class rxHackrf(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "rxHackrf")
        ...
        self.frequency = frequency = 87.9*10**6

        ##################################################
        # Blocks
        ##################################################

        self._frequency_range = Range(87.9*10**6, 107.9*10**6, 200*10**3, 87.9*10**6, 200)
        self._frequency_win = RangeWidget(self._frequency_range, self.set_frequency, "Center Frequency", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.soapy_hackrf_source_0.set_gain(0, 'VGA', min(max(45, 0.0), 62.0))
...
def main(top_block_cls=rxHackrf, options=None):
