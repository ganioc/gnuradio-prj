...
class samprateBlock(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "samprateBlock")
        ...
        self._frequency_range = Range(-samp_rate/2, samp_rate/2, 10, 0, 200)
...
def main(top_block_cls=samprateBlock, options=None):
