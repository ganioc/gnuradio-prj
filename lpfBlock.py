...
class lpfBlock(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Low Pass Filter Block", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Low Pass Filter Block")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lpfBlock")
        ...
        self._frequency_win = RangeWidget(self._frequency_range, self.set_frequency, "freq", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=lpfBlock, options=None):
